 ...
 * @description
 * # UserFactory
 * Factory for providing convenient, parameterised access to the user account related API endpoint ({@link https://github.com/thesgc/chembiohub_ws/wiki/User-API users}).
